...
const ContactForm = () => {
  ...
  return (
    <section className="w-full flex justify-center mb-16">
      <section className="w-11/12 md:w-9/12 relative z-20 bg-cover bg-center rounded-xl"
          ...
          <div className="flex flex-col md:flex-row overflow-hidden rounded-lg">
            ...
            <div className="w-full md:w-1/2 p-6">
              ...
              <form onSubmit={onSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full hover:bg-[#b76e15] bg-[#b76e1f] text-white py-2 rounded-full font-bold"
                >
                  Submit
                </button>
              </form>
